...
namespace Mat
{
	...
	public partial class LookUpMapping : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public object LookUpSourceCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<object>("lookupsourcecode");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		public System.Nullable<Mat.LookUpMappingState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Mat.LookUpMappingState)(System.Enum.ToObject(typeof(Mat.LookUpMappingState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public Mat.SystemUser lk_lookupmapping_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Mat.SystemUser>("lk_lookupmapping_createdby", null);
			}
		}
		...
		public Mat.SystemUser lk_lookupmapping_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Mat.SystemUser>("lk_lookupmapping_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_lookupmapping_createdonbehalfby");
				this.SetRelatedEntity<Mat.SystemUser>("lk_lookupmapping_createdonbehalfby", null, value);
		...
		public Mat.SystemUser lk_lookupmapping_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Mat.SystemUser>("lk_lookupmapping_modifiedby", null);
			}
		}
		...
		public Mat.SystemUser lk_lookupmapping_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Mat.SystemUser>("lk_lookupmapping_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_lookupmapping_modifiedonbehalfby");
				this.SetRelatedEntity<Mat.SystemUser>("lk_lookupmapping_modifiedonbehalfby", null, value);
		...
		public Mat.ColumnMapping LookUpMapping_ColumnMapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Mat.ColumnMapping>("LookUpMapping_ColumnMapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("LookUpMapping_ColumnMapping");
				this.SetRelatedEntity<Mat.ColumnMapping>("LookUpMapping_ColumnMapping", null, value);
