...
namespace Mat
{
	...
	public partial class ImportJob : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Mat.SystemUser lk_importjobbase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Mat.SystemUser>("lk_importjobbase_createdby", null);
			}
		}
		...
		public Mat.SystemUser lk_importjobbase_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Mat.SystemUser>("lk_importjobbase_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_importjobbase_createdonbehalfby");
				this.SetRelatedEntity<Mat.SystemUser>("lk_importjobbase_createdonbehalfby", null, value);
		...
		public Mat.SystemUser lk_importjobbase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Mat.SystemUser>("lk_importjobbase_modifiedby", null);
			}
		}
		...
		public Mat.SystemUser lk_importjobbase_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Mat.SystemUser>("lk_importjobbase_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_importjobbase_modifiedonbehalfby");
				this.SetRelatedEntity<Mat.SystemUser>("lk_importjobbase_modifiedonbehalfby", null, value);
		...
		public Mat.Organization organization_importjob
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Mat.Organization>("organization_importjob", null);
			}
		}
