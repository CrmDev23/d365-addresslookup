...
namespace Mat
{
	...
	public partial class BulkDeleteOperation : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Mat.BulkDeleteOperationState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Mat.BulkDeleteOperationState)(System.Enum.ToObject(typeof(Mat.BulkDeleteOperationState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public Mat.AsyncOperation AsyncOperation_BulkDeleteOperation
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Mat.AsyncOperation>("AsyncOperation_BulkDeleteOperation", null);
			}
		}
		...
		public Mat.SystemUser lk_bulkdeleteoperation_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Mat.SystemUser>("lk_bulkdeleteoperation_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_bulkdeleteoperation_createdonbehalfby");
				this.SetRelatedEntity<Mat.SystemUser>("lk_bulkdeleteoperation_createdonbehalfby", null, value);
		...
		public Mat.SystemUser lk_bulkdeleteoperation_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Mat.SystemUser>("lk_bulkdeleteoperation_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_bulkdeleteoperation_modifiedonbehalfby");
				this.SetRelatedEntity<Mat.SystemUser>("lk_bulkdeleteoperation_modifiedonbehalfby", null, value);
		...
		public Mat.SystemUser lk_bulkdeleteoperationbase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Mat.SystemUser>("lk_bulkdeleteoperationbase_createdby", null);
			}
		}
		...
		public Mat.SystemUser lk_bulkdeleteoperationbase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Mat.SystemUser>("lk_bulkdeleteoperationbase_modifiedby", null);
			}
		}
